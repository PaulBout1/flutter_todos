...
void main() {
  group('TodosOverviewEvent', () {
    ...
    group('TodosOverviewFilterChanged', () {
      test('supports value equality', () {
        expect(
          TodosOverviewFilterChanged(TodosFiltersEnum.all),
          equals(TodosOverviewFilterChanged(TodosFiltersEnum.all)),
        );
      });

      test('props are correct', () {
        expect(
          TodosOverviewFilterChanged(TodosFiltersEnum.all).props,
          equals(<Object?>[
