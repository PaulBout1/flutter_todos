  ...
  group('TodosOverviewBloc', () {
    ...
    group('TodosOverviewSubscriptionRequested', () {
      ...
      blocTest<TodosOverviewBloc, TodosOverviewState>(
        ...
        expect: () => [
          const TodosOverviewState(
            status: TodosStatusEnum.loading,
          ),
          TodosOverviewState(
      ...
      blocTest<TodosOverviewBloc, TodosOverviewState>(
        ...
        act: (bloc) => bloc.add(const TodosOverviewSubscriptionRequested()),
        expect: () => [
          const TodosOverviewState(status: TodosStatusEnum.loading),
          const TodosOverviewState(status: TodosStatusEnum.failure),
        ],
      );
    });
    ...
    group('TodosOverviewFilterChanged', () {
      blocTest<TodosOverviewBloc, TodosOverviewState>(
        ...
        expect: () => const [
          TodosOverviewState(filter: TodosFiltersEnum.completedOnly),
        ],
      );
    });
